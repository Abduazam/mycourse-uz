@php
    $disabled = $errors->any() || empty($this->lesson->title) || empty($this->lesson->description) || empty($this->lesson->course_id) ? true : false;
@endphp
                ...
                <div class="block-content">
                    <div class="col-12">
                        <div class="row w-100 h-100 p-0 m-0">
                            <div class="col-md-7 ps-0">
                                <div class="mb-4">
                                    ...
                                    <input wire:model.debounce.500ms="lesson.title" type="text" class="form-control @error('title'){{ 'is-invalid' }}@enderror" id="title" name="title" placeholder="Course title">
                                    @error('course.title')
                            ...
                            <div class="col-md-5 pe-0">
                                <div class="mb-4">
                                    ...
                                    <select class="form-select" id="course_id" name="course_id" wire:model="lesson.course_id">
                        ...
                        <div class="mb-4" wire:ignore>
                            ...
                            <trix-editor input="description" wire:model.debounce.500ms="lesson.description"></trix-editor>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="space-x-2">
                            <div class="form-check form-switch form-check-inline">
                                <input  wire:model="lesson.active" class="form-check-input @error('active'){{ 'is-invalid' }}@enderror" type="checkbox" value="1" id="active" name="active" checked="">
                        ...
                        @if($additional_files > 0)
                            @for($i = 0; $i < $additional_files; $i++)
                                <div class="mb-4">
                                    ...
                                    <span class="text-danger pt-2 ps-1 small">{{ $message }}</span>
                                    @enderror
                                    @if(isset($lesson->files[$i]) and !isset($files[$i]))
                                        <div class="file-block pt-3">
                                            {!! $lesson->files[$i]->getFile() !!}
                                        </div>
                                    @endif
                                    @if(isset($files[$i]))
                                        @php
...
@push('scripts')
    <script>
        ...
        @this.set('lesson.description', trixEditor.getAttribute('value'))
        })
    </script>
@endpush
