@php
    $disabled = $errors->any() || empty($this->course->title) || empty($this->course->description) ? true : false;
@endphp
                ...
                <div class="block-content">
                    <div class="col-12">
                        <div class="mb-4">
                            ...
                            <input wire:model.debounce.500ms="course.title" type="text" class="form-control @error('title'){{ 'is-invalid' }}@enderror" id="title" name="title" placeholder="Course title">
                            @error('course.title')
                        ...
                        <div class="mb-4" wire:ignore>
                            ...
                            <trix-editor input="description" wire:model.debounce.500ms="course.description"></trix-editor>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="space-x-2">
                            <div class="form-check form-switch form-check-inline">
                                <input  wire:model="course.active" class="form-check-input @error('active'){{ 'is-invalid' }}@enderror" type="checkbox" value="1" id="active" name="active" checked="">
...
@push('scripts')
    <script>
        ...
        @this.set('course.description', trixEditor.getAttribute('value'))
        })
    </script>
@endpush
